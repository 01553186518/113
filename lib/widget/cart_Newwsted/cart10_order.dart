...
class CartPage10 extends StatefulWidget {
  const CartPage10({Key? key}) : super(key: key);

  @override
  State<CartPage10> createState() => _CartPageState();
}

class _CartPageState extends State<CartPage10> {
  int count = 0;
  @override
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Image.asset("lib/assets/prodect/product/tbl_articles_article_23574_40589a60165-7880-4bda-a774-de24458bd85b.jpg"
                              ,height: 80,
                              width: 150,
                            ),
                          ),
