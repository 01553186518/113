...
class CartPage9 extends StatefulWidget {
  const CartPage9({Key? key}) : super(key: key);

  @override
  State<CartPage9> createState() => _CartPageState();
}

class _CartPageState extends State<CartPage9> {
  int count = 0;
  @override
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Image.asset("lib/assets/prodect/product/إعداد_وجبات_سريعة.jpg"
                              ,height: 80,
                              width: 150,
                            ),
                          ),
