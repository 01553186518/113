...
class CartPage8 extends StatefulWidget {
  const CartPage8({Key? key}) : super(key: key);

  @override
  State<CartPage8> createState() => _CartPageState();
}

class _CartPageState extends State<CartPage8> {
  int count = 0;
  @override
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Image.asset("lib/assets/prodect/product/طريقة_عمل_مشروبات_ساخنة_وباردة.jpg"
                              ,height: 80,
                              width: 150,
                            ),
                          ),
