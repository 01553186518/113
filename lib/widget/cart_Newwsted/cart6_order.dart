...
class CartPage6 extends StatefulWidget {
  const CartPage6({Key? key}) : super(key: key);

  @override
  State<CartPage6> createState() => _CartPageState();
}

class _CartPageState extends State<CartPage6> {
  int count = 0;
  @override
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Image.asset("lib/assets/prodect/product/الحمص.jpeg"
                              ,height: 80,
                              width: 150,
                            ),
                          ),
