...
class CartPage12 extends StatefulWidget {
  const CartPage12({Key? key}) : super(key: key);

  @override
  State<CartPage12> createState() => _CartPageState();
}

class _CartPageState extends State<CartPage12> {
  int count = 0;
  @override
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Image.asset("lib/assets/prodect/product/hqdefault.jpg"
                              ,height: 80,
                              width: 150,
                            ),
                          ),
